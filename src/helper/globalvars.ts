...
export const END_POINT_SEND_CLINIC_REGISTRATION_DATA = WORKING_SERVER + "api/register/register_clinic.php";
...
export const END_POINT_SEND_AVAILABILITY = WORKING_SERVER + "api/booking/setAvailability.php";
...
export const END_POINT_GET_ALL_DOCTORS = WORKING_SERVER + "api/search/getDoctor.php";
